//! Pure digest kernels for `Core.Hash` — hex encoding + crc32 / md5 / sha1 / sha256.
//!
...
//! `sha1`, `hash("sha256", …)`. Parity is pinned by unit tests against real `php` output and by the
