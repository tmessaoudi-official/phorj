...
impl Checker {
    pub(super) fn new() -> Self {
        ...
        Checker {
            ...
            cur_class_type_param_bounds: Vec::new(),
            ...
            invoke_call_targets: HashMap::new(),
            to_string_targets: HashMap::new(),
            inferred_type_resolutions: HashMap::new(),
            tuple_field_indices: HashMap::new(),
