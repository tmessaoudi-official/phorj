...
pub(super) fn declare_ub_refs(
    ...
    UbHelperRefs {
        ...
        json_map_get: m.declare_func_in_func(ids.json_map_get, f),
        json_list_len: m.declare_func_in_func(ids.json_list_len, f),
        json_list_get: m.declare_func_in_func(ids.json_list_get, f),
    }
}
