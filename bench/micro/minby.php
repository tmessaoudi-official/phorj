<?php
// Idiomatic PHP counterpart of minby.phg (hand-authored). `__phorj_min_by` is phorj's gated erasure
// (there is no single builtin — PHP `min`/`array_reduce` don't give first-wins-by-key), inlined here as
