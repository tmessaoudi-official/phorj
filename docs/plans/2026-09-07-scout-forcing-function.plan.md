...
- [2026-09-25 16:01] AGREED: **Optional narrowing extends into `&&`, `||` and if-expression arms (DEC-535).** Found
  ...
  if-expression's arms narrow like an if-statement's. Checker-only. Built as NEW row 5r, BEFORE 5d.
