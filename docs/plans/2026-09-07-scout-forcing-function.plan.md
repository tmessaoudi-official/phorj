...
| 5l | DEC-532 — throw-expression: `throw e` as a `never`-typed expression in four positions (right of `??`, ternary branch, `match`-arm body, lambda expression body), named error elsewhere; lifter maps scout's 3 sites (`Core/Text.php:426`, `Job/JobStore.php:256`, `:273`) 1:1; PHP leg native; all legs + LSP + both editors | L | todo | - | src/parser/* src/checker/* src/compiler/* src/interpreter/* src/transpile/* src/lift/* src/lsp/* editors/* tests/differential.rs examples/* |
