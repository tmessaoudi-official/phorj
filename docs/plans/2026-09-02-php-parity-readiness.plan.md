...
| 5 | Doc-drift repair — FEATURES' dependency list named 11 of 15 while claiming \"nothing else\"; fixed and RATCHETED against Cargo.toml | S | done | PENDING | FEATURES.md tests/dependency_claims.rs |
