...
| 3 | Parity-% recompute — M-gap-matrix §4.20 (the OWED DEC-490 close; ≈71/59/72; the full §1.2 re-tally is its still-open second half) | S | done | 13e913a0 | docs/research/full-audit/raw/M-gap-matrix.md |
