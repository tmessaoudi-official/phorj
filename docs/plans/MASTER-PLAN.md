...
> Detected in the post-audit gap session. Current position: **parity ≈69% · vision ≈70% ·
> raw floor ≈55%** (§4.12 recompute, 2026-07-30 — backed enums + phantom-gap credit; §4.10 was ≈66/67/51). Vision = 0.70×parity + 0.30×programme (§11.1, ratified).
