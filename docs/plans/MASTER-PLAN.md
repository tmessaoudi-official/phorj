...
Two earlier banked Invariant-15 questions, neither ruled: **Q-0908-1 `?? throw`** — PHP 8
...
> Detected in the post-audit gap session. Current position (§4.20, 2026-09-05): **parity ≈71% · vision ≈72% ·
> raw floor ≈57%** (§4.13 recompute, 2026-07-30 — backed enums + phantom-gap credit; §4.10 was ≈66/67/51). Vision = 0.70×parity + 0.30×programme (§11.1, ratified).
