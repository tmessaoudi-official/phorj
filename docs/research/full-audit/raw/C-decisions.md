...
**L-19** (P-Q-A-2, D3's ruled wording) · **L-22** (DEC-334 runtime-config catalog / php.ini equivalent) ·
**L-25** (`App\`-prefixing + the `phpInterop{namespaceRoot,sourceRoot}` knob, DEC-320 F2) · **L-28**
(pipe-lambda trailing-op binding) · **L-31** (`VirtualModule.src`→`srcs` rename) · **L-33** (DEC-324's 7
remaining TOP items) · **L-86** (DB column naming, slice B2, + the cross-prelude error-namespace
convention).
